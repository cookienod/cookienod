...
class CookieNod_Updater {
    ...
    public function plugins_api_handler($res, $action, $args) {
        ...
        return (object) array(
            ...
            'download_link' => $update_data->zipball_url ?? $update_data->assets[0]->browser_download_url ?? '',
            'trunk'         => $update_data->zipball_url ?? $update_data->assets[0]->browser_download_url ?? '',
            'requires'      => $plugin_data['RequiresWP'],
            'tested'        => $plugin_data['TestedWP'],
            'requires_php'  => $plugin_data['RequiresPHP'],
